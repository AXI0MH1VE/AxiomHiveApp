#!/usr/bin/env python3
"""
Xcode Project Generator for AxiomHiveApp
Creates the complete .xcodeproj structure with all necessary files
"""
...
def create_project_structure():
    """Create the Xcode project directory structure and files"""
    
    base_path = os.path.dirname(os.path.abspath(__file__))
    
    # Create directory structure
    project_dir = os.path.join(base_path, "AxiomHiveApp.xcodeproj")
...
"""
    ...
    print("✓ Created contents.xcworkspacedata")
...
"""
    ...
    with open(os.path.join(schemes_dir, "AxiomHiveApp.xcscheme"), "w") as f:
        f.write(scheme_content)
    
    print("✓ Created AxiomHiveApp.xcscheme")
    
    print("\n✅ Xcode project structure created successfully!")
    print("\nCreated files:")
    print("  • AxiomHiveApp.xcodeproj/project.pbxproj")
    print("  • AxiomHiveApp.xcodeproj/project.xcworkspace/contents.xcworkspacedata")
    print("  • AxiomHiveApp.xcodeproj/xcshareddata/xcschemes/AxiomHiveApp.xcscheme")
    print("\nThe project is now ready to open in Xcode 15.2+")
    print("Run: open AxiomHiveApp.xcodeproj")
